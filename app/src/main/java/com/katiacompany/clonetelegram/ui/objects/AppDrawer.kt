package com.katiacompany.clonetelegram.ui.objects

import android.view.View
import androidx.appcompat.widget.Toolbar
import androidx.appcompat.app.AppCompatActivity
import com.katiacompany.clonetelegram.R
import com.katiacompany.clonetelegram.ui.fragments.SettingsFragment
...
class AppDrawer(val mainActivity: AppCompatActivity, private val toolbar: Toolbar) {
    ...
    private fun createHeader() {
        mHeader = AccountHeaderBuilder()
            ...
            .addProfiles(
                ProfileDrawerItem().withName("Katerina Morozova")
                    .withEmail("+7(XXX)XXX-XX-XX")
            ).build()
    }
}